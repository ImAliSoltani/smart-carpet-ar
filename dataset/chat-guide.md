...
| پس‌زمینه سفیدِ خالص است؟ کف چوبی یا خاکستری نیست؟ | «فرش را روی پس‌زمینه‌ی کاملاً سفید (#FFFFFF) و یکدست بگذار، بدون هیچ بافت یا سایه‌ای.» |
| کل فرش در کادر است؟ هیچ لبه‌ای بریده نشده؟ | «کل فرش با هر چهار لبه در کادر باشد و هیچ گوشه‌ای بریده نشود.» |
